...
public class MuaGiaiController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<SeasonResponseDTO>>> getAllSeasons(
        ...
        return ResponseEntity.ok(ApiResponse.success(muaGiaiService.getAllSeasons(pageable, keyword, status, organizerScopeId)));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<SeasonResponseDTO>> getSeasonById(@PathVariable String id, Authentication authentication) {
        String organizerScopeId = currentUserService.resolveOrganizerId(authentication);
        return ResponseEntity.ok(ApiResponse.success(muaGiaiService.getSeasonById(id, organizerScopeId)));
    }
    ...
    public ResponseEntity<ApiResponse<SeasonResponseDTO>> createSeason(
        ...
        String organizerScopeId = currentUserService.resolveOrganizerId(authentication);
        SeasonResponseDTO created = muaGiaiService.createSeason(dto, staffId, organizerScopeId);
    ...
    public ResponseEntity<ApiResponse<SeasonResponseDTO>> updateSeason(
        ...
        String staffId = currentUserService.resolveMaTK(authentication);
        String organizerScopeId = currentUserService.resolveOrganizerId(authentication);
        return ResponseEntity.ok(ApiResponse.success(muaGiaiService.updateSeason(id, dto, staffId, organizerScopeId)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteSeason(@PathVariable String id, Authentication authentication) {
        String staffId = currentUserService.resolveMaTK(authentication);
        String organizerScopeId = currentUserService.resolveOrganizerId(authentication);
        muaGiaiService.deleteSeason(id, staffId, organizerScopeId);
    ...
    public ResponseEntity<ApiResponse<Void>> closeSeason(@PathVariable String id, Authentication authentication) {
        String staffId = currentUserService.resolveMaTK(authentication);
        String organizerScopeId = currentUserService.resolveOrganizerId(authentication);
        muaGiaiService.closeSeason(id, staffId, organizerScopeId);
        return ResponseEntity.ok(ApiResponse.success(null, "Đã đóng mùa giải"));
    }

    @GetMapping("/{id}/point-rules")
    public ResponseEntity<ApiResponse<List<PointRuleResponseDTO>>> getPointRules(@PathVariable String id, Authentication authentication) {
        String organizerScopeId = currentUserService.resolveOrganizerId(authentication);
        return ResponseEntity.ok(ApiResponse.success(muaGiaiService.getPointRules(id, organizerScopeId)));
    }
    ...
    public ResponseEntity<ApiResponse<List<PointRuleResponseDTO>>> setPointRules(
        ...
        String staffId = currentUserService.resolveMaTK(authentication);
        String organizerScopeId = currentUserService.resolveOrganizerId(authentication);
        return ResponseEntity.ok(ApiResponse.success(muaGiaiService.setPointRules(id, rules, staffId, organizerScopeId), "Đã cập nhật luật tính điểm"));
    }
}
