...
const HorseDetailPage = () => {
  ...
  if (isLoading) {
    return <LoadingSpinner className="py-24" text="Đang tải thông tin ngựa..." />;
  }
  ...
  if (!horse) {
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        ...
        <Button variant="ghost" onClick={() => navigate('/horses')} className="mt-4">
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <Button variant="ghost" onClick={() => navigate('/horses')} className="mb-6">
        <ArrowLeft className="h-4 w-4 mr-2" />Quay lại danh sách ngựa
      </Button>
